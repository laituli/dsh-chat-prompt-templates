...
`;
		function PromptRoot(props) {
			...
			const [nodeMode, setNodeMode] = (0, react.useState)({});
			...
			const [dockH, setDockH] = (0, react.useState)(() => {
				try {
			...
			const dockMax = () => Math.max(DOCK_H_MIN, Math.round((window.innerHeight || 720) * .72));
			const clampDock = (h) => Math.min(dockMax(), Math.max(DOCK_H_MIN, h));
			const dragY = (0, react.useRef)(null);
			const onVHandleDown = (e) => {
				e.preventDefault();
				const base = document.querySelector(".pt-dock")?.offsetHeight ?? dockH ?? 300;
			...
			const modeOf = (0, react.useCallback)((path) => nodeMode[path] ?? "stack", [nodeMode]);
			const setModeOf = (0, react.useCallback)((path, m) => {
				setNodeMode((prev) => ({
					...prev,
					[path]: m
				}));
			...
			const composePath = (0, react.useCallback)((path) => {
				...
				return text.replace(/\{\{\s*([\w-]+)\s*\}\}/g, (_all, nm) => resolve(nm));
			}, [tree]);
			(0, react.useEffect)(() => {
				let alive = true;
				(async () => {
			...
			const clearParam = (0, react.useCallback)((path, param) => {
				...
				setNodeMode((prev) => {
					...
					const prefix = `${child}:`;
					for (const key of Object.keys(next)) if (key === child || key.startsWith(prefix)) delete next[key];
					return next;
				});
			...
			const unnestParam = (0, react.useCallback)((path, param) => {
				...
				setNodeMode((prev) => {
					...
					for (const key of Object.keys(next)) if (key === childKey || key.startsWith(prefix)) delete next[key];
					return next;
				});
				setEditing({
					path,
			...
			const nestedChildren = (0, react.useCallback)((path) => {
				if (!tree) return [];
				const n = tree.get(path);
				if (!n) return [];
				const out = [];
			...
			const rows = (0, react.useMemo)(() => {
				if (!tree) return [];
				const out = [];
				const walk = (path, depth, forceAll) => {
					const n = tree.get(path);
					if (!n) return;
					out.push({
						path,
			...
			const hasAnyTree = (0, react.useMemo)(() => Object.values(nodeMode).includes("tree"), [nodeMode]);
			const rootNode = tree ? tree.get("root") ?? null : null;
			const fullText = (0, react.useMemo)(() => rootNode ? composePath("root") : "", [rootNode, composePath]);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: `pt-dock${dockH ? " fixed" : ""}`,
				style: dockH ? { height: dockH } : void 0,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "pt-body",
						children: rootNode && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: `pt-wrap${hasAnyTree || dockH ? " pt-scroll" : ""}`,
							children: rows.map((row) => {
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: "mid",
											children: paramsOf(row.node).map((p) => {
												...
												return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
													className: cls,
													title: isTpl ? `${p.label}：子模板` : `${p.label}：点击=用聊天框编辑`,
													children: [
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
															className: "lb",
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: "pt-rowctl",
											children: [
												kids.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
													className: "pt-mode",
													title: "该节点的显示模式：栈=聚焦路径；树=整棵子树",
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
														className: m === "stack" ? "on" : "",
														title: "栈：只显示 聚焦节点→根 的路径",
														onClick: () => setModeOf(row.path, "stack"),
														children: "栈"
													}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
														className: m === "tree" ? "on" : "",
														title: "树：展开本节点全部嵌套子树",
														onClick: () => setModeOf(row.path, "tree"),
														children: "树"
													})]
												}),
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
													className: "pt-ic",
													title: isRoot ? "预览整树（将交付给 agent 的内容）" : "预览本行组合内容",
													onClick: () => setPreview({
														title: isRoot ? "整树组合（交付内容）" : `本行预览：${row.node.tpl.title}`,
														text: (isRoot ? fullText : composePath(row.path)) || "（空）"
													}),
													children: I.eye
												}),
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "pt-vhandle",
						title: "拖动调整面板高度（松手记忆）",
						onPointerDown: onVHandleDown
					}),
